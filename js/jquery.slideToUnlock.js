...
class slideToUnlock {
  ...
  init() {
    ...
    this.$drag.on(
      "mousedown.slideToUnlock touchstart.slideToUnlock",
  ...
  touchStart(event = window.event) {
    ...
    $(document).on(
      "mousemove.slideToUnlock touchmove.slideToUnlock",
      this.touchMove.bind(this)
    );
    $(document).on(
      "mouseup.slideToUnlock touchend.slideToUnlock",
  ...
  touchMove(event = window.event) {
    ...
    this.$progressBar.css({
      width: edge - this.$el.offset().left + this.$drag.outerWidth(),
    });
